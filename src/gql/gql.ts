...
type Documents = {
	...
	'query WishlistFetch {\n  me {\n    id\n    metafield(key: "wishlist")\n  }\n}': typeof types.WishlistFetchDocument;
	"query WishlistProducts($ids: [ID!], $channel: String!) {\n  products(first: 100, channel: $channel, filter: {ids: $ids}) {\n    edges {\n      node {\n        ...ProductListItem\n      }\n    }\n  }\n}": typeof types.WishlistProductsDocument;
	"mutation WishlistUpdate($id: ID!, $input: [MetadataInput!]!) {\n  updateMetadata(id: $id, input: $input) {\n    errors {\n      field\n      message\n      code\n    }\n  }\n}": typeof types.WishlistUpdateDocument;
};
const documents: Documents = {
	...
	'query WishlistFetch {\n  me {\n    id\n    metafield(key: "wishlist")\n  }\n}':
		types.WishlistFetchDocument,
	"query WishlistProducts($ids: [ID!], $channel: String!) {\n  products(first: 100, channel: $channel, filter: {ids: $ids}) {\n    edges {\n      node {\n        ...ProductListItem\n      }\n    }\n  }\n}":
		types.WishlistProductsDocument,
	"mutation WishlistUpdate($id: ID!, $input: [MetadataInput!]!) {\n  updateMetadata(id: $id, input: $input) {\n    errors {\n      field\n      message\n      code\n    }\n  }\n}":
		types.WishlistUpdateDocument,
};
 ...
 */
export function graphql(
	source: 'query WishlistFetch {\n  me {\n    id\n    metafield(key: "wishlist")\n  }\n}',
): typeof import("./graphql").WishlistFetchDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query WishlistProducts($ids: [ID!], $channel: String!) {\n  products(first: 100, channel: $channel, filter: {ids: $ids}) {\n    edges {\n      node {\n        ...ProductListItem\n      }\n    }\n  }\n}",
): typeof import("./graphql").WishlistProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "mutation WishlistUpdate($id: ID!, $input: [MetadataInput!]!) {\n  updateMetadata(id: $id, input: $input) {\n    errors {\n      field\n      message\n      code\n    }\n  }\n}",
): typeof import("./graphql").WishlistUpdateDocument;
